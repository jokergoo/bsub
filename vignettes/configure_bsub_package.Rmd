...
You can find examples from https://github.com/jokergoo/bsub/blob/master/R/config.R .

If you have difficulty to configure **bsub** package for your cluster, please
